...
public class MicroIndex extends Rectangle {
  ...
  public MicroIndex( CellInfo cell ) {
    super.set(cell);
  }

  public MicroIndex(MicroIndex other) {
  ...
  public Text toText(Text text) {
    ...
    TextSerializerHelper.serializeInt( indexId, text, ',');
  ...
  public boolean equals(Object obj) {
    if (obj == null)
      return false;
    return this.indexId ==((MicroIndex)obj).getIndexId();
  }
  
  public void expand(MicroIndex p) {
    super.expand(p);
    // accumulate size
    this.size += p.size;
  ...
  @Override
  public String toWKT() {
    return super.toWKT()+"\t"+recordCount+"\t"+size+"\t"+indexId ;
  }
}
