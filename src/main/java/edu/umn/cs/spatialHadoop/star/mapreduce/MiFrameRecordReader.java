 ...
 *
 */
public class MiFrameRecordReader<V extends Shape> extends
    RecordReader<Partition, Iterable<V>> {

  private static final Log LOG = LogFactory.getLog(MiFrameRecordReader.class);
